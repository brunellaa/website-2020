  ...
  return (
    <section className="about max-content">
      <div className="about__info">
        ...
        <p className="about__info__text">
          Ive been working in the field for 12 years and have a wide variety of
          skills and usefull traits learned during this time, im self taught in
          many aspects and i enjoy learning more every day.
        </p>
      </div>
      ...
      <div className="about__links">
        ...
        <button className="button button__primary__void">Download my CV</button>
      </div>
    </section>
  );
}
